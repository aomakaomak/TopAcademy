...
def zodiac_signs(our_month: str, day: str) -> str or None:
    """
    ...
    И зацените проверку корректности месяца ))))  Если ввели что-то не то, то мы просто пишем, что наша
    переменная месяца равна 13, и это автоматически далее вызовет ошибку.  Не нужно вручную писать
